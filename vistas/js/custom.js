...
$(document).ready(function()
{
	...
	*/
	...
	$("#cant").change(function(){
		var personas = $("#cant").val()
		var precio = $(this).attr("unit")
		var total = personas * precio
		total = total.toLocaleString(
		undefined, // leave undefined to use the visitor's browser 
					// locale or a string like 'en-US' to override it.
		{ minimumFractionDigits: 0 }
		);
		var preciostr = Number($(this).attr("unit"))
		preciostr = preciostr.toLocaleString(
		undefined, // leave undefined to use the visitor's browser 
					// locale or a string like 'en-US' to override it.
		{ minimumFractionDigits: 0 }
		);
		// console.log(preciostr)
		$("#calcularTotal").text(personas+" x "+preciostr+" = "+total)
	})
...
var heightInfo = $(".container-info-servicio").css("height")

// console.log(screen.width)

if(screen.width >= 768){

	$(".images-gallery").css("height", heightInfo)

}else{

	$(".images-gallery").css("height", "250px")
