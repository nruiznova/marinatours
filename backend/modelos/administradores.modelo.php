...
class ModeloAdministradores{
	...
	static public function mdlRegistroAdministradores($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, usuario, password,  perfil, permisos, estado) VALUES (:nombre, :usuario, :password, :perfil, :permisos, :estado)");
	...
	static public function mdlEditarAdministrador($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, usuario = :usuario, password = :password,  perfil = :perfil, permisos = :permisos WHERE id = :id");
	...
	static public function mdlEditarGaleria($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, galeria = :galeria WHERE id_galeria = :id_galeria");
	...
	static public function mdlNuevaSeccion($tabla, $datos){

		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, galeria) VALUES (:nombre, :galeria)");
	...
	static public function mdlEliminarGaleria($tabla, $id){
