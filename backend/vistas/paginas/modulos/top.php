  ...
  <div class="card">
        ...
        <div class="input-group-prepend">
          ...
          if(isset($_GET["id_s"])){ 
            ...
            if(isset($servicios[$_GET["id_s"] - 1])){
              ...
              echo 'index.php?pagina=inicio'.$get_ventas.'&id_s='.($_GET["id_s"] - 1).'&fecha='.$fecha;

            }else{

              echo 'index.php?pagina=inicio'.$get_ventas.'&id_s=0'.'&fecha='.$fecha;
    ...
    <div class="card-footer">
      ...
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text">
          <a class="" href="index.php?pagina=inicio<?php echo $get_ventas; ?>&fecha=<?php if(isset($_GET["id_s"])){ $id = $_GET["id_s"]; }else{ $id = 0; } echo date('Y-m-d', strtotime('-1 day', strtotime($fecha))).'&id_s='.$id; ?>">&laquo;</a>
          </span>
        </div>
        <input type="text" class="form-control text-center" value="<?php echo date("d-m-Y", strtotime($fecha)); ?>" disabled>
        <div class="input-group-append">
          <span class="input-group-text"><a class="" href="index.php?pagina=inicio<?php echo $get_ventas; ?>&fecha=<?php if(isset($_GET["id_s"])){ $id = $_GET["id_s"]; }else{ $id = 0; } echo date('Y-m-d', strtotime('+1 day', strtotime($fecha))).'&id_s='.$id; ?>">&raquo;</a></span>
        </div>
      </div>
  ...
  <div class="card">
    ...
    <div class="card-footer">
      ...
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text">
          <a class="" href="index.php?pagina=inicio<?php echo $get_ventas; ?>&fecha_total=<?php if(isset($_GET["id_s"])){ $id = $_GET["id_s"]; }else{ $id = 0; } echo date('Y-m-d', strtotime('-1 day', strtotime($fecha_total))).'&id_s='.$id; ?>">&laquo;</a>
          </span>
        </div>
        <input type="text" class="form-control text-center" value="<?php echo date("d-m-Y", strtotime($fecha_total)); ?>" disabled>
        <div class="input-group-append">
          <span class="input-group-text"><a class="" href="index.php?pagina=inicio<?php echo $get_ventas; ?>&fecha_total=<?php if(isset($_GET["id_s"])){ $id = $_GET["id_s"]; }else{ $id = 0; } echo date('Y-m-d', strtotime('+1 day', strtotime($fecha_total))).'&id_s='.$id; ?>">&raquo;</a></span>
        </div>
      </div>
